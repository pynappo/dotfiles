...
local mappings = {
  ["n"] = {
    ...
    { "<leader>sf", [[ts.find_files { previewer = false }]]},
    { "<leader>sb", ts.current_buffer_fuzzy_find},
    { "<leader>sh", ts.help_tags},
    { "<leader>st", ts.tags},
    { "<leader>sd", ts.grep_string},
    { "<leader>sp", ts.live_grep},
    { "<leader>so", [[ts.tags { only_current_buffer = true }]]},
    { "<leader>?", ts.oldfiles},
    -- Diagnostics
