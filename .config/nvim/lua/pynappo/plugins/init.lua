...
require('lazy').setup(
  {
    ...
    },
    {
      ...
      config = function()
        ...
        require('pynappo/autocmds').create_autocmd(
          'ColorScheme',
          {
            callback = function()
    ...
    },
    {
      ...
      dependencies = {
        { 'SmiteshP/nvim-navic', dependencies = { 'neovim/nvim-lspconfig' }, config = function() require('pynappo/plugins/navic') end },
        { 'lewis6991/gitsigns.nvim', dependencies = { 'nvim-lua/plenary.nvim' }, config = function() require('pynappo/plugins/gitsigns') end },
      }
    },
